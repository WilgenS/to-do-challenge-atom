...
jest.mock("../../database/firestore-task.repository");
jest.mock("../../database/firestore-user.repository");
...
describe("TaskController", () => {
  ...
  describe("getTasks", () => {
    it("should return 200 and the list", async () => {
      ...
      (FirestoreUserRepository.prototype.getAll as jest.Mock).mockResolvedValue([]);
